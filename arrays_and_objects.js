...
cats_and_owners.forEach(function(catAndOwner){    /* this variable represents one thing in the arrary */
...
let nobel_prize_category = nobel_prize[0].category
console.log(nobel_prize_category)